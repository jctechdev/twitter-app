...
const getTwitterData = (nextPage = false) => {
  ...
  if (!query) return;
  const encodedQuery = encodeURIComponent(query); /*for search with symbols*/
  ...
  tweets.map((tweet) => {
    ...
    twitterContent += `
        ...
        <div class="tweet-user-info">
            <div class="tweet-user-profile" style="background-image: url(${tweet.user.profile_image_url})"></div>
